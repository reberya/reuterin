...
h
pdf(paste0('~/Desktop/projects/reuterin/out/figures/reuterin_degs_', format(Sys.time(), "%Y-%m-%d"), '.pdf'), height = 4, width = 6)
h
dev.off()
...
h
pdf(paste0('~/Desktop/projects/reuterin/out/figures/reuterin_degs_noLab_', format(Sys.time(), "%Y-%m-%d"), '.pdf'), height = 4, width = 6)
h
dev.off()
