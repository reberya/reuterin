...
Choosing those with top # DE genes or any with a cysteine proteomics hit. Ultimately chose to eliminate cysteine proteomics data. 
```{r}
...
# Remove cysteine proteomics
export.sub %<>% dplyr::filter(!is.na(logFC))
